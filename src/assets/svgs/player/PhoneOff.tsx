...
export default function PhoneOff({ ...props }: FansSvgProps) {
	return (
		<Svg
		...
		>
			<G id="Group_52190">
				<G id="Group_52190-2" transform="translate(20.672 4.637)">
					<Path
						id="Path_46856"
						fill={props.color ?? "currentColor"}
						d="M.5 11.3c.6.6 1.6.6 2.2 0l3.2-3.2 1.7 1.7 1.5 1.5c.6.6 1.5.6 2.1 0h.1c.6-.6.6-1.6 0-2.2l-.4-.4-2.8-2.8 1.3-1.3 1.9-1.9c.6-.6.6-1.6 0-2.2S9.7-.1 9.1.5L7.7 1.8 5.9 3.7 2.7.5C2.2 0 1.4-.1.8.2L.5.5c-.6.6-.6 1.6 0 2.2l3.2 3.2L.5 9.1c-.7.6-.8 1.5-.2 2.1 0 .1 0 .1.2.1z"
					/>
				</G>
				<G id="Group_52191">
					<Path
