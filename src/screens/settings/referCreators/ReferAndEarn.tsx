							...
							{!tw.prefixMatch("lg") ? (
								...
								<FansView alignItems="center">
									...
									<FansText
										...
										fontSize={16}
									>
										Check our blogs about how to find
										creators.
									</FansText>
								</FansView>
							)}
							...
							<FansView alignItems="center">
								...
								<FansView style={tw.style("max-w-[320px]")}>
									...
									>
										...
										with a 10% share from this referral
									</FansText>
								</FansView>
							</FansView>
							{/* ~ Lifetime passive income */}
							...
							<FansView alignItems="center">
								...
								<FansView maxWidth={255}>
									<FansText
										...
										textAlign="center"
									>
										Start referring creators today, and see
										your networth soar
									</FansText>
								</FansView>
								<FansGap height={20} />
