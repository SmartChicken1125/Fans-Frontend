...
import { IFanReferral } from "@usertypes/types";
...
import EditLinkDialog from "../referCreators/dialogs/EditLinkDialog";
import ViewAnalyticsDialog from "../referCreators/dialogs/ViewAnalyticsDialog";
import ReferralLinkCreatedModal from "../referCreators/modal/ReferralLinkCreatedModal";
...
const ReferAndEarnScreen = (
	...
	const [link, setLink] = useState<IFanReferral | undefined>(
		props.route.params?.profile?.fanReferrals?.find(
			(el) => el.userId == userInfo.id,
		),
	);
	...
	const [selectedReferral, setSelectedReferral] = useState<IFanReferral>();
	...
	const getLinkCode = () => {
		return `https://fyp.fans/?r=${link?.code ?? ""}`;
	};
	const handlePressCopy = () => {
		setStringAsync(getLinkCode());
		ToastMessage.show({
			type: "success",
			text1: "Copied",
		});
					...
					<FansScreen3 contentStyle={tw.style("p-[0px]")}>
						...
						>
							...
							<FansView alignItems="center">
								<FansView>
									<UserAvatar
										size="95px"
										image={
											props.route?.params?.profile?.avatar
										}
									/>
									<FansReferralStarsSvg
										width={34.796}
										height={34.796}
										colorFans="fans-white"
										style={{
											position: "absolute",
											top: 67,
											left: 87,
								...
								<FansView style={tw.style("max-w-[319px]")}>
									<FansText
										...
										textAlign="center"
									>
										Earn an industry-leading lifetime share
										of {"\n"}
										{
											props.route?.params?.profile
												?.fanReferralShare
							...
							>
								...
								<FansView
									style={tw.style(
										"max-w-[255px] lg:max-w-none",
									)}
								>
									<FansText fontSize={16} textAlign="center">
										Starting referring fans today, and see
										your earnings soar
									</FansText>
								</FansView>
								<FansGap height={20} />
							...
							<FansGap height={{ lg: 52, xs: 35 }} />
							<FansHorizontalDivider />
							<FansGap height={{ lg: 46, xs: 29 }} />
							...
							<FansText fontFamily="inter-regular" fontSize={16}>
								To manage payouts and view detailed analytics,
							...
							>
								...
								>
									...
									>
										This isn’t luck; it’s the power of our
										Referral Program. Start building a
										passive income stream today and set foot
										on the path to financial freedom. Your
										success story is waiting to be written!
									</FansText>
								</FansView>
								<FansGap height={26} />
							</FansView>
									...
									<FansView alignItems="center">
										...
										>
											<FansText
												...
												textAlign="center"
											>
												Harness the power of data. Dive
												into your personalized analytics
											</FansText>
										</FansView>
									</FansView>
									{/* ~ Insightful analytics */}
									...
									<FansView alignItems="center">
										...
										<FansView maxWidth={255}>
											<FansText
												...
												textAlign="center"
											>
												Start referring fans today, and
												see your earnings soar
											</FansText>
										</FansView>
										<FansGap height={20} />
